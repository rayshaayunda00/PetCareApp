...
<head>
    ...
    <style>
        .hero { background: linear-gradient(135deg, #4d9fda, #1e67a8); color: white; padding: 80px 0; border-radius: 0 0 30px 30px; }
        .card:hover { transform: scale(1.05); transition: 0.3s; }
        .card { box-shadow: 0 4px 10px rgba(0,0,0,0.1); border: none; border-radius: 15px; }
        footer { background: #1e67a8; color: white; padding: 20px 0; margin-top: 50px; border-radius: 30px 30px 0 0; }
    </style>
</head>
<body>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card p-3 text-center">
                ...
                <p>Periksa rutin kesehatan hewan peliharaan Anda.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 text-center">
        ...
        <div class="col-md-4">
            <div class="card p-3 text-center">
                ...
                <p>Jasa penitipan hewan dengan pengawasan dokter.</p>
            </div>
        </div>
    </div>
</div>
